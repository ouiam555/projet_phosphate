...
| | | | |
|:---:|:---:|:---:|:---:|
| 🐍 **Python** | 🗄️ **Snowflake** | 🔧 **dbt** | 📊 **Power BI** |
| 🌬️ **Airflow** | 🪣 **MinIO** | 🐳 **Docker** | 🤖 **Scikit-Learn** |
...
| Élément | Détail |
|---|---|
| 🏷️ **Nom du projet** | Global Phosphate Market Analytics Platform |
...
flowchart LR
    ...
    C --> D[❄️ Snowflake<br/>Bronze]
    D --> E[🔧 dbt<br/>Silver]
    E --> F[🔧 dbt<br/>Gold]
    F --> G[🤖 Machine Learning]
    F --> H[📊 Power BI]
    G --> H
    I[🌬️ Airflow — Orchestration] -.-> B
    I -.-> C
    I -.-> D
    I -.-> E
    I -.-> F
...
| 🪣 **Stockage** | MinIO |
| ❄️ **Entrepôt de données** | Snowflake |
...
| ⚠️ Risque | Impact | Probabilité | Mitigation |
|---|---|---|---|
...
- ☁️ Migration complète vers une orchestration cloud managée
